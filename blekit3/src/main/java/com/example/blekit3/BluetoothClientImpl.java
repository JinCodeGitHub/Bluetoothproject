...
import com.example.blekit3.BluetoothContext;
import com.example.blekit3.BluetoothService;
import com.example.blekit3.BluetoothServiceImpl;
import com.example.blekit3.Constants;
import com.example.blekit3.IBluetoothClient;
...
import com.example.blekit3.connect.response.BluetoothResponse;
import com.example.blekit3.model.BleGattProfile;
import com.example.blekit3.receiver.BluetoothReceiver;
import com.example.blekit3.receiver.listener.BleCharacterChangeListener;
import com.example.blekit3.receiver.listener.BleConnectStatusChangeListener;
import com.example.blekit3.receiver.listener.BluetoothBondListener;
import com.example.blekit3.receiver.listener.BluetoothBondStateChangeListener;
import com.example.blekit3.receiver.listener.BluetoothStateChangeListener;
...
import com.example.blekit3.utils.ListUtils;
import com.example.blekit3.utils.proxy.ProxyBulk;
import com.example.blekit3.utils.proxy.ProxyInterceptor;
import com.example.blekit3.utils.proxy.ProxyUtils;
...
import static com.example.blekit3.Code.SERVICE_UNREADY;
import static com.example.blekit3.Constants.CODE_CLEAR_REQUEST;
import static com.example.blekit3.Constants.CODE_CONNECT;
import static com.example.blekit3.Constants.CODE_DISCONNECT;
import static com.example.blekit3.Constants.CODE_INDICATE;
import static com.example.blekit3.Constants.CODE_NOTIFY;
import static com.example.blekit3.Constants.CODE_READ;
import static com.example.blekit3.Constants.CODE_READ_DESCRIPTOR;
import static com.example.blekit3.Constants.CODE_READ_RSSI;
import static com.example.blekit3.Constants.CODE_REFRESH_CACHE;
import static com.example.blekit3.Constants.CODE_REQUEST_MTU;
import static com.example.blekit3.Constants.CODE_SEARCH;
import static com.example.blekit3.Constants.CODE_STOP_SESARCH;
import static com.example.blekit3.Constants.CODE_UNNOTIFY;
import static com.example.blekit3.Constants.CODE_WRITE;
import static com.example.blekit3.Constants.CODE_WRITE_DESCRIPTOR;
import static com.example.blekit3.Constants.CODE_WRITE_NORSP;
import static com.example.blekit3.Constants.DEVICE_FOUND;
import static com.example.blekit3.Constants.EXTRA_BYTE_VALUE;
import static com.example.blekit3.Constants.EXTRA_CHARACTER_UUID;
import static com.example.blekit3.Constants.EXTRA_DESCRIPTOR_UUID;
import static com.example.blekit3.Constants.EXTRA_GATT_PROFILE;
import static com.example.blekit3.Constants.EXTRA_MAC;
import static com.example.blekit3.Constants.EXTRA_MTU;
import static com.example.blekit3.Constants.EXTRA_OPTIONS;
import static com.example.blekit3.Constants.EXTRA_REQUEST;
import static com.example.blekit3.Constants.EXTRA_RSSI;
import static com.example.blekit3.Constants.EXTRA_SEARCH_RESULT;
import static com.example.blekit3.Constants.EXTRA_SERVICE_UUID;
import static com.example.blekit3.Constants.EXTRA_TYPE;
import static com.example.blekit3.Constants.GATT_DEF_BLE_MTU_SIZE;
import static com.example.blekit3.Constants.SEARCH_CANCEL;
import static com.example.blekit3.Constants.SEARCH_START;
import static com.example.blekit3.Constants.SEARCH_STOP;
