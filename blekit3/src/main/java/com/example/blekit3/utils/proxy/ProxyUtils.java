package com.example.blekit3.utils.proxy;

import com.example.blekit3.channel.Channel;
...
public class ProxyUtils {
    ...
    public static <T> T getProxy(Object object, Channel interceptor) {
        return (T) getUIProxy(object, object.getClass().getInterfaces(), (ProxyInterceptor) interceptor);
    }
