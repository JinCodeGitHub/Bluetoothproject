...
public class RequestUtils {
    ...
    private CallBackUtils mCallBack;//回调接口
    ...
    RequestUtils(String methodType, String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackUtils callBack) {
        this(methodType,url,null,null,null,null,null,null,paramsMap,headerMap,callBack);
    }

    RequestUtils(String methodType, String url, String jsonStr, Map<String, String> headerMap, CallBackUtils callBack) {
        this(methodType,url,jsonStr,null,null,null,null,null,null,headerMap,callBack);
    }

    RequestUtils(String methodType, String url, Map<String, String> paramsMap, File file, String fileKey, String fileType, Map<String, String> headerMap, CallBackUtils callBack) {
        this(methodType,url,null,file,null,fileKey,null,fileType,paramsMap,headerMap,callBack);
    }
    RequestUtils(String methodType, String url, Map<String, String> paramsMap, List<File> fileList, String fileKey, String fileType, Map<String, String> headerMap, CallBackUtils callBack) {
        this(methodType,url,null,null,fileList,fileKey,null,fileType,paramsMap,headerMap,callBack);
    }
    RequestUtils(String methodType, String url, Map<String, String> paramsMap, Map<String, File> fileMap, String fileType, Map<String, String> headerMap, CallBackUtils callBack) {
        this(methodType,url,null,null,null,null,fileMap,fileType,paramsMap,headerMap,callBack);
    }

    private RequestUtils(String methodType, String url, String jsonStr , File file , List<File> fileList, String fileKey , Map<String,File> fileMap, String fileType, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackUtils callBack) {
    ...
    private static class ProgressRequestBody extends RequestBody {
        ...
        ProgressRequestBody(RequestBody requestBody, CallBackUtils callBack) {
        ...
        private Sink sink(BufferedSink sink) {
            return new ForwardingSink(sink) {
                ...
                public void write(Buffer source, long byteCount) throws IOException {
                    ...
                    CallBackUtils.handler.post(new Runnable() {
                        @Override
                        public void run() {
